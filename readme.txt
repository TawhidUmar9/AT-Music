...
rec_type_ name will be used - rec_type table banaite hobe(done)
platfom _name nibo, ja theke platform id ber kora lagbe.-> platfrom table lagbe.(done)
name dibo
song_length dibo

popularity dibo ba na dibo -> ja will be calculated later on basis of rating.

like korle popularity bere update kore hobe.
****************** song like korle, the popularity should be updated.
